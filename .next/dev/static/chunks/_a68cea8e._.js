...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const { ok, data } = isRegister ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerUser"])(email, name, password) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])(email, password);
            if (!ok) {
...
_s(LoginPage, "AK6XrRzqJnR7RZ0M0Cdf7bLX0y0=", false, function() {
    return [
...
//# sourceMappingURL=_a68cea8e._.js.map