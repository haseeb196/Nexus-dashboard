  ...
  return (
    <header style={{
      ...
      <div>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: 12.5, margin: "2px 0 0", dangerouslySetInnerHTML: { __html: subtitle || defaultSubtitle.replace(user?.name || "", `<strong style="color:var(--text-secondary)">${user?.name || ""}</strong>`) } }} />
      </div>
